...
extension AlertState where Action == AppReducer.Action.Alert {
    ...
    public static func nukeLocalDatabasesSucceeded() -> AlertState {
        AlertState {
            TextState(L10n.Nighthawk.SettingsTab.Advanced.NukeLocalDatabases.Alert.Success.title)
        } message: {
            TextState(L10n.Nighthawk.SettingsTab.Advanced.NukeLocalDatabases.Alert.Success.message)
        }
    }

    public static func nukeLocalDatabasesFailed() -> AlertState {
        AlertState {
            TextState(L10n.Nighthawk.SettingsTab.Advanced.NukeLocalDatabases.Alert.Failed.title)
        }
    }
}
