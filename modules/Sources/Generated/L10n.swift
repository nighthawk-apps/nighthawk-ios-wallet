...
public enum L10n {
  ...
  public enum Nighthawk {
    ...
    public enum ImportWarning {
      /// Only import a seed phrase that was originally generated by Nighthawk. Other wallets handle notes differently, which can result in Nighthawk not being able to properly discover your funds.
      public static let description = L10n.tr("Localizable", "nighthawk.importWarning.description", fallback: "Only import a seed phrase that was originally generated by Nighthawk. Other wallets handle notes differently, which can result in Nighthawk not being able to properly discover your funds.")
      /// Proceed
