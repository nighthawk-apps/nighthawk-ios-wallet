...
public struct NighthawkTextField<InputAccessoryContent>: View where InputAccessoryContent: View {
    private var placeholder: String?
    private var text: Binding<String>
    private var isValid: NighthawkTextFieldValidationState
    ...
    public init(
        ...
        text: Binding<String>,
        isValid: NighthawkTextFieldValidationState = .valid,
        isSecure: Bool = false,
