...
DarkFi-era version notes live in the root [README.md](README.md) (TestFlight **3.00.013** build 13) and [docs/app-features.md](docs/app-features.md). Older 0.0.1 entries below are historical and are not the current product.
