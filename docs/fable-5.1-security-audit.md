...
**Shipped:** TestFlight `3.00.014` build 14; FFI `darkfi-mobile-ffi` 0.2.1 (synced from Android)  
...
| I1.7 | Tx direction from `"Broadcasted"` | **PARTIAL** | Depends on FFI history; FFI now writes Broadcasted |
...
| I1.12 | Chat `isOutgoing` nick-spoofable / silent Tor-off | **PENDING** | Chat privacy follow-ups |
