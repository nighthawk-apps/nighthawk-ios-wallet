...
internal enum L10n {
  ...
  internal enum Field {
    ...
    internal enum TransactionAddress {
      ...
      /// Valid Zcash Address
      internal static let validDarkFiAddress = L10n.tr("Localizable", "field.transactionAddress.validDarkFiAddress", fallback: "Valid Zcash Address")
    }
  ...
  internal enum Home {
    ...
    /// Stealth Wallet
    internal static let title = L10n.tr("Localizable", "home.title", fallback: "Stealth Wallet")
  ...
  internal enum Nighthawk {
    ...
    internal enum RecoveryPhraseDisplay {
      ...
      internal static let pdfHeader = L10n.tr("Localizable", "nighthawk.recoveryPhraseDisplay.pdfHeader", fallback: "These are seed words used to restore your DarkFi in Nighthawk Wallet:")
    ...
    internal enum WalletTab {
      ...
      /// ZEC
      internal static let zec = L10n.tr("Localizable", "nighthawk.walletTab.zec", fallback: "DRK")
    }
  ...
  internal enum PlainOnboarding {
    ...
    /// It's time to set up your Nighthawk wallet.
    internal static let title = L10n.tr("Localizable", "plainOnboarding.title", fallback: "It's time to set up your Nighthawk wallet.")
    internal enum Button {
      /// Create a new Wallet
